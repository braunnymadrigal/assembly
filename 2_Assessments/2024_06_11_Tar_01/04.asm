...
.DATA
    ...
    ;; VENTANITA
    asciiVenta db 032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032,032 ; asciis a imprimir en la ventana
    valorVenta db 000,000,000,000,001,000,000,000,000,001,000,000,000,000,000,000,000,000,000,000,000  ; array de valores
    contaVenta dw 0  ; saber por que valor de los arrays Venta vamos
    seconds db 1
    ...
    Caracte db 048,049,050,051,052,053,054,055,056,057,043,045,042,047,061,100
...
AuxTest PROC  ; impime ciertas variables para usarlo como debugger casero
    ...
    LoopChPrint:
        ...
        mov cx, 1  ; cuantas veces toca imprimir
        mov al, asciiVenta[si]  ; elegir caracter
        mov ah, 09h  ; modo 9 (imprime un caracter n veces en un puntero definido)
        int 10h  ; interrupcion 10h
        
        inc dl  ; columna en ventana
        inc si  ; incrementa indice en array
        cmp si, 21
        jl LoopChPrint
    ret
AuxTest ENDP
