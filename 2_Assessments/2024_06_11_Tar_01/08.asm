...
; Ya traduje el codigo diavlo.py a asm y funciona, falta lo de verificar que lo que haya digitado este nice y ponerse a calcular
.model SMALL                               
.STACK 512                                 
...
.DATA
    ...
    arrayVenta db 000,000,000,000,001,000,000,000,000,000,001,000  ; array de valores
...
CleanVent PROC  ; limpia la ventanita y limpia todo en general para simular que la calcu se reinicio
    ...
    mov bl, 02h  ; elegir color, bl = fondo:caracter
    mov cx, 4  ; cuantas veces toca imprimir
