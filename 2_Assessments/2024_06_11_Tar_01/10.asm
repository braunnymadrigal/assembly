...
; solo falta hacer un imprimir resultado correcto
; y tengo un error en la forma en que verifico que num2 sea mayor que 0
.model SMALL                               
.STACK 512                                 
...
CheckErr PROC
    ...
    jg callPrintErr
    cmp arrayVenta[4], 1  ; if arrayVenta[4] < 1
    jl callPrintErr
    ...
    jg callPrintErr
    cmp arrayVenta[10], 1  ; if arrayVenta[10] < 1
    jl callPrintErr
...
PrintRes PROC
    mov ax, numE
    mov auxB02, al
    ; Imprimir A la carrera el numerador
    mov dl, contaVenta  ; columna contaVenta
    mov dh, 01 ; fila 0
    mov bh, 0  ; pagina 0
    mov ah, 02h  ; modo 2 (manipula el puntero)
    ...
    mov bl, 05h  ; elegir color, bl = fondo:caracter
    mov cx, 01  ; cuantas veces toca imprimir
    mov al, auxB02  ; caracter a imprimir
    mov ah, 09h  ; modo 9 (imprime un caracter n veces en un puntero definido)
    int 10h  ; interrupcion 10h
    inc contaVenta
    ...
    mov ax, numF
    mov auxB02, al
    ; Imprimir A la carrera el denominadro
    mov dl, contaVenta  ; columna contaVenta
    mov dh, 01 ; fila 0
    mov bh, 0  ; pagina 0
    mov ah, 02h  ; modo 2 (manipula el puntero)
